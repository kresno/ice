$(function() {
  ...
  if($('#chartjsBarAsmas').length) {
    new Chart($("#chartjsBarAsmas"), {
      type: 'bar',
      data: {
        labels: [ "Desa Darmareja", "Desa Sukaraja", "Desa Sukabumi", "Desa Cikakak", "Desa Cisolok"],
        datasets: [
          {
            label: "Population",
            backgroundColor: ["#b1cfec","#7ee5e5","#66d1d1","#f77eb9","#4d8af0"],
  ...
  if($('#chartjsDoughnutPokir').length) {
    new Chart($('#chartjsDoughnutPokir'), {
      type: 'doughnut',
      data: {
        labels: ["Infrastruktur", "Pemberdayaan", "Hibah"],
        datasets: [
          {
            label: "Usulan(Buah)",
  ...
  if($('#chartjsDoughnutAsmas').length) {
    new Chart($('#chartjsDoughnutAsmas'), {
      type: 'doughnut',
      data: {
        labels: ["Infrastruktur", "Pemberdayaan", "Hibah"],
        datasets: [
