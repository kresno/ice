...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Pokir</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-xl-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Pengusul Usulan Pokir 5 terbanyak</h6>
                <canvas id="chartjsBarPokir"></canvas>
            </div>
        </div>
    </div>
    <div class="col-xl-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Urusan Usulan Pokir 5 terbanyak 2022</h6>
                <canvas id="chartjsBarUsulanPokir"></canvas>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Data Tabel Pokir</h6>
...
if ($('#chartjsBarPokir').length) {
    new Chart($("#chartjsBarPokir"), {
        type: 'bar',
        data: {
            labels: [<?php foreach($usulanterbanyak as $a): { echo '"' . $a->pengusul . '",';} endforeach; ?>],
            datasets: [{
                label: "Banyak Usulan",
...
if ($('#chartjsBarUsulanPokir').length) {
    new Chart($("#chartjsBarUsulanPokir"), {
        type: 'bar',
        data: {
